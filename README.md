...
**⚠️ IMPORTANT: If you're getting "JavaFX runtime components are missing" error:**
...
### 🔍 Check What's Wrong:
Run `check-setup.bat` to see exactly what needs to be fixed.

### 📖 Detailed Instructions:
- [README_FIRST.md](README_FIRST.md) - Start here for setup
- [FIX_JAVAFX_ERROR.md](FIX_JAVAFX_ERROR.md) - Detailed error fix guide
- [QUICK_START.md](QUICK_START.md) - Step-by-step manual setup

**Note:** The IDE run configuration (`.vscode/launch.json`) is machine-specific. It's automatically generated by `setup-and-run.bat`, or run `fix-ide-config.bat` manually.
